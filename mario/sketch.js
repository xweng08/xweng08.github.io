...
function createEnemies(){
  ...
  pinkEnemy1 = new Enemy(idlePinkEnemy[0], 150, 732, 150, 320, ENEMY, idlePinkEnemy, walkingPinkEnemy) // long platform (left)
  pinkEnemy2 = new Enemy(idlePinkEnemy[0], 220, 302, 221, 290, ENEMY, idlePinkEnemy, walkingPinkEnemy) // middle platform
  pinkEnemy3 = new Enemy(idlePinkEnemy[0], 840, 668, 840, 1000, ENEMY, idlePinkEnemy, walkingPinkEnemy) // long platform (right)
  ...
  greenEnemy2 = new Enemy(idleGreenEnemy[0], 960, 476, 960, 1050, ENEMY, idleGreenEnemy, walkingGreenEnemy) // small floating platform
  greenEnemy3 = new Enemy(idleGreenEnemy[0], 230, 876, 230, 515, ENEMY, idleGreenEnemy, walkingGreenEnemy) // bottom platform
